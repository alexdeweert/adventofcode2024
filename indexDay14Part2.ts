...
/**
 * The solution to this was to output apprx 10000 frames to a text file
 * and use linux less command to view that file one page at a time.
 * 
 * On frame 7709 the bots converge into an image of a christmas tree.
 * 
 * See "day14HiddenImage.txt"
 */
